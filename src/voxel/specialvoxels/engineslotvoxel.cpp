...
EngineSlotVoxel::EngineSlotVoxel(const glm::ivec3& cell, int index):
    SpecialVoxel(cell, index, Property<uint32_t>::get("voxels.engineSlot.color"), Property<float>::get("voxels.engineSlot.density"), Property<float>::get("voxels.engineSlot.hp")),
