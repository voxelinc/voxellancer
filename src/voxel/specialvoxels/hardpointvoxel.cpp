...
HardpointVoxel::HardpointVoxel(const glm::ivec3& gridCell, int index):
    SpecialVoxel(gridCell, index, Property<uint32_t>::get("voxels.hardpoint.color"), Property<float>::get("voxels.hardpoint.unscaledMass"), Property<float>::get("voxels.hardpoint.hp")),
    m_hardpoint(nullptr)
{
