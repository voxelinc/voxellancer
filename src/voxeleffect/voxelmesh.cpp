    ...
    glow::VertexArrayObject* vao)
{
    ...
    setupVertexAttribute(v_vectexLocation, vao, "v_vertex", GL_FALSE, vertexBindingIndex, 0);
    setupVertexAttribute(v_normalLocation, vao, "v_normal", GL_TRUE, normalBindingIndex, sizeof(glm::vec3));
}
